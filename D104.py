...
def ICC():
    try:
        ...
        print(colored("[✓]", "green"), colored("С уважением D104", "magenta"))
        print("")
        sys.exit(1)
        
        
print(colored("Проверка сети... (Пару секунд)", "green"))
print("")
sleep(1)
ICC()
...
def Sup():
    ...
    if varik == "1" or varik == "ПриватБанк (Карта)":
        print("")
        qiwi2 = colored("PrivatBank - 5168 7574 0198 4903", "yellow")
        print(qiwi2)
        print("")
        print("")
        print(quu)
        ...
        if varik2 == "0" or varik2 == "Назад":
            ...
            sys.exit(0)
    elif varik == "2" or varik == "Банковская карта":
        print("")
        qiwi3 = colored("ПриватБанк - 5168 7574 0198 4903", "yellow")
        print(colored(qiwi3))
        print("")
        print("")
        print(quu)
        ...
        if varik3 == "0" or varik3 == "Назад":
            ...
            print(colored("ДУРНОЙ ДА??", "red"))
            sys.exit(0)
    elif varik == "3" or varik == "ДОСТУПЕН ТОЛЬКО ПРИВАТ":
        print("")
        qiwi4 = colored("ПриватБанк - 5168 7574 0198 4903", "yellow")
        print(colored(qiwi4))
        print("")
        print("")
        print(quu)
...
def act():
    ...
    if actr == "1" or act == "Update":
        ...
        print("")
        sleep(1.45)
        os.system("cd && rm -rf D104 && git clone https://github.com/D104/D104 && cd D104 && python D104.py")
        sys.exit(0)
        print("")
...
def ES():
	...
	if es == "1" or es == "start":
		...
		print("")
		addr_from = "sandsmsd104@gmail.com"  # Адресат
		addr_to = Email1  # Получатель
		password = "sandsmsd104sandsmsd104"  # Пароль
...
def programm():
    ...
    print(lan, lang)
    vk = colored("НЕИЗВЕСТНЫЙ", "magenta")
    vkp = colored("VK -", "cyan")
    print(vkp, vk)
    tg = colored("https://t.me/bot_dinis", "cyan")
